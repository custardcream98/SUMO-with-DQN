...
class SumoEnvironment(gym.Env):
    def __init__(self, env_config):
        ...
        #     writer.writeheader()
        with open('result_model2.csv', 'w', newline='', encoding='utf-8') as csvfile:
        ...
        self.route_file = "intersection_case1.rou.xml"
        ...
        ## 행동
        ### Model Type 2
        ### 현시 순서 고정, 최소/최대 녹색시간 부여, 주기 최소/최대 
    ...
    def step(self, action): # 시뮬레이션의 매 스텝별 명령 메소드, 상태와 보상 리턴 후 결정된 행동이 입력 
       # 현재 현시 정보 획득
        ...
        if traci.simulation.getMinExpectedNumber() > 0:
            ...
            with open('result_model2.csv', 'a', newline='', encoding='utf-8') as csvfile:
                writer = csv.DictWriter(csvfile, fieldnames=MOE_HEADERS)
    ...
    def comptue_reward(self):
        ...
        self.cum_reward += -(queueLength_hat)
